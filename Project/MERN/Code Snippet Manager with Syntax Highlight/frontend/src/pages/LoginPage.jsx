    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-16">
      <div className="animate-rise rounded-2xl border border-[var(--color-line)] bg-white p-6 shadow-[0_12px_40px_rgba(26,31,54,0.06)] sm:p-8">
        ...
        <p className="mt-1 text-sm text-[var(--color-muted)]">
          Log in to open your snippet library.
        </p>
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-xl bg-[var(--color-ink)] py-2.5 text-sm font-semibold text-white transition hover:bg-[#2a314f] disabled:opacity-60"
          >
        ...
        <p className="mt-5 text-center text-sm text-[var(--color-muted)]">
          New here?{' '}
          <Link to="/register" className="font-semibold text-[var(--color-ember)]">
            Create an account
          </Link>
        </p>
      </div>
